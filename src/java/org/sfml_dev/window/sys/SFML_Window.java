...
public class SFML_Window {
    ...
    public static native void sf_Mouse_getPosition(long ret);
    public static native void sf_Mouse_getPosition(long ret, long relativeTo);
    ...
    public static native void sf_Touch_getPosition(long ret, int finger);
    public static native void sf_Touch_getPosition(long ret, int finger, long relativeTo);
    ...
    public static native void sf_Window_getPosition(long ret, long this_);
    public static native void sf_Window_setPosition(long this_, long position);
    public static native void sf_Window_getSize(long ret, long this_);
