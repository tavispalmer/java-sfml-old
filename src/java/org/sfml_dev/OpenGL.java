...
public class OpenGL {
    ...
    public static native void glEnableClientState( int cap );  /* 1.1 */

    public static native void glDisableClientState( int cap );  /* 1.1 */
    ...
    public static native void glPushClientAttrib( int mask );  /* 1.1 */

    public static native void glPopClientAttrib( );  /* 1.1 */
    ...
    public static native long  glGetString( int name );
    ...
    */
    ...
    public static native void glOrtho( double left, double right,
                                    double bottom, double top,
                                    double near_val, double far_val );

    public static native void glFrustum( double left, double right,
                                    double bottom, double top,
                                    double near_val, double far_val );

    public static native void glViewport( int x, int y,
    ...
    public static native void glRotated( double angle,
                                    double x, double y, double z );
    public static native void glRotatef( float angle,
    ...
    */
    ...
    public static native byte glIsList( int list );
    ...
    public static native void glCallLists( int n, int type,
                                        long lists );
    ...
    */
    ...
    public static native void glIndexub( byte c );  /* 1.1 */
    ...
    public static native void glIndexubv( long c );  /* 1.1 */
    ...
    public static native void glColor4b( byte red, byte green,
                                    byte blue, byte alpha );
    public static native void glColor4d( double red, double green,
                                    double blue, double alpha );
    public static native void glColor4f( float red, float green,
                                    float blue, float alpha );
    public static native void glColor4i( int red, int green,
                                    int blue, int alpha );
    public static native void glColor4s( short red, short green,
                                    short blue, short alpha );
    public static native void glColor4ub( byte red, byte green,
                                        byte blue, byte alpha );
    public static native void glColor4ui( int red, int green,
                                        int blue, int alpha );
    public static native void glColor4us( short red, short green,
                                        short blue, short alpha );
    ...
    */
    ...
    public static native void glVertexPointer( int size, int type,
                                        int stride, long ptr );

    public static native void glNormalPointer( int type, int stride,
                                        long ptr );

    public static native void glColorPointer( int size, int type,
                                        int stride, long ptr );

    public static native void glIndexPointer( int type, int stride,
                                        long ptr );

    public static native void glTexCoordPointer( int size, int type,
                                            int stride, long ptr );

    public static native void glEdgeFlagPointer( int stride, long ptr );

    public static native void glGetPointerv( int pname, long params );

    public static native void glArrayElement( int i );

    public static native void glDrawArrays( int mode, int first, int count );

    public static native void glDrawElements( int mode, int count,
                                        int type, long indices );

    public static native void interleavedArrays( int format, int stride,
                                            long pointer );
    ...
    */
    ...
    public static native void glLightfv( int light, int pname,
                                    long params );
    public static native void glLightiv( int light, int pname,
                                    long params );

    public static native void glGetLightfv( int light, int pname,
                                        long params );
    public static native void glGetLightiv( int light, int pname,
                                        long params );
    ...
    */
    ...
    public static native void glPixelMapfv( int map, int mapsize,
                                        long values );
    public static native void glPixelMapuiv( int map, int mapsize,
                                        long values );
    public static native void glPixelMapusv( int map, int mapsize,
                                        long values );
    ...
    public static native void glBitmap( int width, int height,
                                    float xorig, float yorig,
                                    float xmove, float ymove,
                                    long bitmap );

    public static native void glReadPixels( int x, int y,
                                        int width, int height,
                                        int format, int type,
                                        long pixels );

    public static native void glDrawPixels( int width, int height,
                                        int format, int type,
                                        long pixels );

    public static native void glCopyPixels( int x, int y,
                                        int width, int height,
                                        int type );
    ...
    */
    ...
    public static native void glGetTexParameterfv( int target,
                                            int pname, long params);
    public static native void glGetTexParameteriv( int target,
                                            int pname, long params );

    public static native void glGetTexLevelParameterfv( int target, int level,
                                                    int pname, long params );
    public static native void glGetTexLevelParameteriv( int target, int level,
                                                    int pname, long params );


    public static native void glTexImage1D( int target, int level,
                                        int internalFormat,
    ...
    public static native void glGetTexImage( int target, int level,
                                        int format, int type,
                                        long pixels );
    ...
    public static native void glPrioritizeTextures( int n,
                                                long textures,
                                                long priorities );

    public static native byte glAreTexturesResident( int n,
                                                    long textures,
                                                    long residences );
    ...
    public static native void glTexSubImage1D( int target, int level,
                                        int xoffset,
    ...
    public static native void glCopyTexImage1D( int target, int level,
                                            int internalformat,
                                            int x, int y,
                                            int width, int border );
    ...
    public static native void glCopyTexSubImage1D( int target, int level,
    ...
    */
    ...
    public static native void glMap1d( int target, double u1, double u2,
                                int stride,
                                int order, long points );
    public static native void glMap1f( int target, float u1, float u2,
                                int stride,
                                int order, long points );

    public static native void glMap2d( int target,
                double u1, double u2, int ustride, int uorder,
                double v1, double v2, int vstride, int vorder,
                long points );
    public static native void glMap2f( int target,
    ...
    public static native void glMapGrid2d( int un, double u1, double u2,
                                    int vn, double v1, double v2 );
    public static native void glMapGrid2f( int un, float u1, float u2,
